...
def resample_run(iso_path, star_path, wrt_path, resample_num, resample_age, EEP_path = None, Consider_Lumi=True, Uniform_Resample=True,iso_D=False):
    check_file(iso_path)
    ...
    if Uniform_Resample == False:
        ...
        EEPs = None
    Mass_star, Lumi_star, Rad_star = resample_stars(df_iso.loc[resample_age], Mass_star, Mass_star_p_err, Mass_star_m_err, Lumi_star, Lumi_star_p_err, Lumi_star_m_err, Rad_star, Rad_star_p_err, Rad_star_m_err, resample_num, EEPs = EEPs,Uniform_Resample= Uniform_Resample)
    chi2_data = calculate_chi2(df_iso.loc[resample_age:resample_age], Mass_star, Mass_star_p_err, Mass_star_m_err, Lumi_star, Lumi_star_p_err, Lumi_star_m_err, Rad_star, Rad_star_p_err, Rad_star_m_err, Consider_Lumi = Consider_Lumi)
