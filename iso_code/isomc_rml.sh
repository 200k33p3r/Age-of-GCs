#! /bin/csh
#modified from isomc.sh to output only radius, mass and luminosity
#for fitting individual stars
...
#from a red giant branch monte carlo simulation
 ...
 setenv track  /data/NGC3201_data/NGC3201_tracks
 setenv var   /data/NGC3201_data/NGC3201_var
 setenv run   $local
