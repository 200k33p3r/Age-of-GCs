program PhotoPropI
  ...
  real, parameter :: Vmax = -11.71
  real, parameter :: Vmin = -15.697
  real, parameter :: IImax = -11.332
  real, parameter :: IImin = -15.509
  real, parameter,dimension(2) :: short_long = [-14.05, -14.015]
