program PhotometricProperties
  ...
  real, parameter :: Vmax = -10.998
  real, parameter :: Vmin = -14.998
  real, parameter :: VImin = -0.314
  real, parameter :: VImax = 0.034
  real, parameter :: Vshort_long = -14.138 !magnitude between short/long
                     !exposure
