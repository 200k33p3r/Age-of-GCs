program PhotometricProperties
  ...
  real, parameter :: Vmax = -11.3733
  real, parameter :: Vmin = -15.3683
  real, parameter :: VImin = -0.5194
  real, parameter :: VImax = -0.1383
  real, parameter :: Vshort_long = -14.173 !magnitude between short/long
                     !exposure
