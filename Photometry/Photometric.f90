program PhotometricProperties
  ...
  real, parameter :: Vmax = -11.01
  real, parameter :: Vmin = -15.01
  real, parameter :: VImin = -0.308
  real, parameter :: VImax = 0.029
  real, parameter :: Vshort_long = -13.41 !magnitude between short/long
                     !exposure
